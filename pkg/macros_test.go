...
func TestEvaluateMacro(t *testing.T) {
	...
	tcs := []struct {
		...
		{name: "__timeGroup", args: []string{"col", "1d", "NULL"}, response: "floor(extract(epoch from col)/86400)*86400", fillMode: NullFill},
		{name: "__timeGroup", args: []string{"col", "1d", "previous"}, response: "floor(extract(epoch from col)/86400)*86400", fillMode: PreviousFill},
		{name: "__timeGroup", args: []string{"col", "1d", "12"}, response: "floor(extract(epoch from col)/86400)*86400", fillMode: ValueFill, fillValue: 12},
		// __timeGroupAlias
		...
		{name: "__timeGroupAlias", args: []string{"col", "1d", "NULL"}, response: "floor(extract(epoch from col)/86400)*86400 AS time", fillMode: NullFill},
		{name: "__timeGroupAlias", args: []string{"col", "1d", "previous"}, response: "floor(extract(epoch from col)/86400)*86400 AS time", fillMode: PreviousFill},
		{name: "__timeGroupAlias", args: []string{"col", "1d", "12"}, response: "floor(extract(epoch from col)/86400)*86400 AS time", fillMode: ValueFill, fillValue: 12},
